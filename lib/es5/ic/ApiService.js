...
var APIService = /** @class */ (function () {
    function APIService(apiKey) {
        ...
        this.destroy = function (apiKey) {
            _this.destroyed = true;
            _this.storage.destroy();
            (0, utils_1.warn)(apiKey, "APIService: destroyed");
        };
        ////////////////////////////////////////////////
        // Private
        ////////////////////////////////////////////////
        this.callConfigRegistryRecursively = function (apiParameters, retriesLeft) { return __awaiter(_this, void 0, void 0, function () {
            var apiKey, configRegistryResponse, _a, timeout, timeout;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        apiKey = apiParameters.apiKey;
                        (0, utils_1.log)(apiKey, "APIService.callConfigRegistryRecursively: start with", { retriesLeft: retriesLeft });
                        return [4 /*yield*/, this.getResult(apiParameters, REGISTRY_REDIRECT_RETRIES)];
                    case 1:
                        configRegistryResponse = _b.sent();
                        (0, utils_1.log)(apiKey, "APIService.callConfigRegistryRecursively: result", configRegistryResponse);
                    ...
                    case 3:
                        ...
                        (0, utils_1.log)(apiKey, "APIService.callConfigRegistryRecursively: changeTopology : sleep for ".concat(timeout, "ms"));
                    ...
                    case 4:
                        ...
                        _b.label = 5;
                    case 5:
                        (0, utils_1.warn)(apiKey, "APIService.callConfigRegistryRecursively: changeTopology : skipped - destroyed");
                        return [3 /*break*/, 13];
                    case 6:
                        if (!!this.destroyed) return [3 /*break*/, 10];
                        if (!(retriesLeft > 0)) return [3 /*break*/, 8];
                        timeout = (0, exports.getTimeout)(GLOBAL_RETRIES - retriesLeft, exports.timeoutBetweenRetriesSec);
                        (0, utils_1.log)(apiKey, "sleep for", timeout, "ms");
                        return [4 /*yield*/, (0, utils_1.delayPromise)(timeout)];
                    case 7:
                        _b.sent();
                        return [2 /*return*/, this.callConfigRegistryRecursively(apiParameters, retriesLeft - 1)];
                    case 8:
                        (0, utils_1.warn)(apiKey, "APIService.callConfigRegistryRecursively: retry : skipped - no more retries");
                        _b.label = 9;
                    case 9: return [3 /*break*/, 11];
                    case 10:
                        (0, utils_1.warn)(apiKey, "APIService.callConfigRegistryRecursively: retry : skipped - destroyed");
                        _b.label = 11;
        ...
        this.getResult = function (apiParameters, retriesLeft) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                (0, utils_1.log)(apiParameters.apiKey, "APIService.getResult: using", { canisterIds: canisterIds, currentSessionTopologyId: currentSessionTopologyId });
        ...
        this.callActorRecursively = function (canisterId, apiParameters, retriesLeft, useActorMethodWithConsensus) { return __awaiter(_this, void 0, void 0, function () {
            var apiKey, result, e_1, apiResult, changeTopology, newTopologyId, newPrincipals, newCanisterIds, i, principalToRedirectTo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiKey = apiParameters.apiKey;
                        (0, utils_1.log)(apiKey, "CoordinatorApi.callActorRecursively: start with", { currentSessionTopologyId: currentSessionTopologyId, canisterId: canisterId, useActorMethodWithConsensus: useActorMethodWithConsensus, retriesLeft: retriesLeft });
                    ...
                    case 2:
                        result = _a.sent();
                        (0, utils_1.log)(apiKey, "APIService.callActorRecursively: result", result);
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        (0, utils_1.warn)(apiKey, "APIService.callActorRecursively: caught error", e_1);
                    ...
                    case 4:
                        if ((0, utils_1.isOk)(result)) {
                            ...
                            (0, utils_1.log)(apiKey, "APIService.callActorRecursively: changeTopology : new canisterIds from new topology", newCanisterIds);
                            ...
                            if (!this.destroyed) {
                                if (retriesLeft > 0) {
                                    ...
                                    (0, utils_1.warn)(apiKey, "APIService.callActorRecursively: redirect : skip - no more retries");
                                }
                            }
                            else {
                                (0, utils_1.warn)(apiKey, "APIService.callActorRecursively: redirect : skip - destroyed");
                            }
                            return [2 /*return*/, (0, utils_1.createErrFatal)()];
                        }
                            ...
                            if (!this.destroyed) {
                                if (retriesLeft > 0) {
                                    ...
                                    (0, utils_1.warn)(apiKey, "APIService.callActorRecursively: retryWithConsensusRequest : skip - no more retries");
                                }
                            }
                            else {
                                (0, utils_1.warn)(apiKey, "APIService.callActorRecursively: retryWithConsensusRequest : skip - destroyed");
                            }
                        }
    ...
    APIService.prototype.getConfigStoreApi = function (apiParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var apiKey, result, apiResult, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiKey = apiParameters.apiKey;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        (0, utils_1.log)(apiKey, "APIService.getConfigStoreApi: start with", apiParameters);
                        return [4 /*yield*/, this.callConfigRegistryRecursively(apiParameters, GLOBAL_RETRIES)];
                    case 2:
                        result = _a.sent();
                        (0, utils_1.log)(apiKey, "APIService.getConfigStoreApi: result", result);
                        if (!this.destroyed) {
                            if ((0, utils_1.isOk)(result)) {
                                apiResult = result.ok;
                                return [2 /*return*/, {
                            ...
                            (0, utils_1.warn)(apiKey, "APIService.getConfigStoreApi: result skipped - destroyed");
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        e_2 = _a.sent();
                        (0, utils_1.warn)(apiKey, "APIService.getConfigStoreApi: caught error", e_2);
                        return [3 /*break*/, 4];

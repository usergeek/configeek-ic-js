...
var Fetcher = /** @class */ (function () {
    function Fetcher() {
        var _this = this;
        this.fetch = function (parameters) { return __awaiter(_this, void 0, void 0, function () {
            var canisterId, configStoreActor, context, result, resultData, responseParameters, _a, updatedKeys, removedKeys, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        (0, utils_1.log)("Fetcher.fetch: start with", parameters);
                        ...
                        return [4 /*yield*/, getConfigRecursively(configStoreActor, context)];
                    case 1:
                        result = _b.sent();
                        (0, utils_1.log)("Fetcher.fetch: getConfigRecursively result", result);
                        switch (result.status) {
                            ...
                            case "error": {
                                (0, utils_1.warn)("Fetcher.fetch: getConfigRecursively error", result.reason);
                                return [2 /*return*/, {
                                        status: "error",
                            ...
                            case "unknownError": {
                                //nop
                                (0, utils_1.warn)("Fetcher.fetch: getConfigRecursively unknownError");
                    ...
                    case 2:
                        error_1 = _b.sent();
                        (0, utils_1.warn)("Fetcher.fetch: caught error", error_1);
                        throw error_1;
...
var getConfigRecursively = function (actor, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, utils_1.log)("Fetcher.getConfigRecursively: start with", context);
            ...
            case 1:
                result = _a.sent();
                (0, utils_1.log)("Fetcher.getConfigRecursively: getConfigFullContinuation result", result);
                if (!(0, utils_1.isOk)(result)) return [3 /*break*/, 3];
                return [4 /*yield*/, processFullPartial(actor, context, result.ok)];
            ...
            case 6:
                result = _a.sent();
                (0, utils_1.log)("Fetcher.getConfigRecursively: getConfig result", result);
            ...
            case 8:
                ...
                return [4 /*yield*/, processFullPartial(actor, newContext, fullPartial)];
...
var processFullPartial = function (actor, context, fullPartial) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, getConfigRecursively(actor, newContext)];

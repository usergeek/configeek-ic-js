...
var ConfigeekClient = /** @class */ (function () {
    function ConfigeekClient() {
         ...
         */
        this.newInstance = function () { return new ConfigeekClient(); };
        this.init = function (config) {
            ...
            try {
                (0, utils_1.log)((_b = _this.config) === null || _b === void 0 ? void 0 : _b.apiKey, "Configeek: initialized with config: ".concat(JSON.stringify(config)));
            }
            catch (e) {
            }
        ...
        this.getAll = function () {
            ...
            try {
                ...
                (0, utils_1.warn)((_a = _this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.getAll", e);
            }
        };
        /**
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            result = _d.sent();
                            (0, utils_1.log)((_a = this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.fetchConfig: result", result);
                            if (result) {
                                ...
                                if (result.continuationHint === true) {
                                    (0, utils_1.log)((_b = this.config) === null || _b === void 0 ? void 0 : _b.apiKey, "ConfigeekClient.fetchConfig: will fetch again");
                                    this.fetchConfig();
                                    return [2 /*return*/];
                                }
                            }
                        ...
                        case 2:
                            e_1 = _d.sent();
                            (0, utils_1.warn)((_c = this.config) === null || _c === void 0 ? void 0 : _c.apiKey, "ConfigeekClient.fetchConfig", e_1);
                            return [3 /*break*/, 3];
        ...
        this.startPeriodicFetching = function () {
            ...
            try {
                ...
                (0, utils_1.warn)((_a = _this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.startPeriodicFetching", e);
            }
        };
        this.stopPeriodicFetching = function () {
            ...
            try {
                ...
                (0, utils_1.warn)((_a = _this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.stopPeriodicFetching", e);
            }
        };
        /**
    ...
    ConfigeekClient.prototype.getValue = function (key) {
        ...
        try {
            ...
            (0, utils_1.warn)((_a = this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.getValue", e);
        }
    };
    Object.defineProperty(ConfigeekClient.prototype, "isPeriodicFetchingEnabled", {
        get: function () {
            ...
            try {
                ...
                (0, utils_1.warn)((_a = this.config) === null || _a === void 0 ? void 0 : _a.apiKey, "ConfigeekClient.isPeriodicFetchingEnabled", e);
                return false;
            }
        },
        enumerable: false,

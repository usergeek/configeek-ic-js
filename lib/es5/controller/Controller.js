...
var Controller = /** @class */ (function () {
    function Controller(config) {
        ...
        this.fetch = function () { return __awaiter(_this, void 0, void 0, function () {
            var apiKey, configStoreApiResult, updateId, fetchParameters, result, isConfigurationEmptyState, updateId_1, updatedKeys, hasKeysToProcess, updatedKeys, updatedKeys, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(configStoreApiResult.status === "success")) return [3 /*break*/, 12];
                        ...
                        return [4 /*yield*/, this.fetcher.fetch(fetchParameters, apiKey)];
                    case 3:
                        result = _a.sent();
                        (0, utils_1.log)(apiKey, "Controller.fetch: result", result);
                        if (!!this.destroyed) return [3 /*break*/, 10];
                        if (!result) return [3 /*break*/, 9];
                        if (!(result.status === "error")) return [3 /*break*/, 8];
                        if (!(result.reason === "invalidate")) return [3 /*break*/, 6];
                        isConfigurationEmptyState = updateId === 0;
                        if (!isConfigurationEmptyState) return [3 /*break*/, 5];
                        //will try to fetch configuration
                        (0, utils_1.warn)(apiKey, "Controller.fetch: error: invalidate - will retry to fetch configuration");
                    ...
                    case 6:
                        if (result.reason === "wrongToken") {
                            //destroy api
                            (0, utils_1.warn)(apiKey, "Controller.fetch: error: wrongToken - destroy api");
                            ...
                            (0, utils_1.warn)(apiKey, "Controller.fetch: error: outdatedReplica - do nothing");
                        }
                        _a.label = 7;
                    ...
                    case 10:
                        (0, utils_1.warn)(apiKey, "Controller.fetch: result skipped - destroyed");
                        _a.label = 11;
                    case 11: return [3 /*break*/, 13];
                    case 12:
                        (0, utils_1.warn)(apiKey, "Controller.fetch: result failed - destroy api");
                        this.configStoreApiPromise = undefined;
                        _a.label = 13;
                    case 13: return [3 /*break*/, 15];
                    case 14:
                        e_1 = _a.sent();
                        (0, utils_1.warn)(apiKey, "Controller.fetch: caught error", e_1);
                        return [3 /*break*/, 15];
        ...
        this.destroy = function () {
            ...
            if (_this.apiService) {
                _this.apiService.destroy(_this.config.apiKey);
            }
            (0, utils_1.warn)(_this.config.apiKey, "Controller: destroyed");
        };
        ////////////////////////////////////////////////
        // Private
        ////////////////////////////////////////////////
        ...
        this.getConfigStoreApi = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        configStoreApiResult = _a.sent();
                        (0, utils_1.log)(this.config.apiKey, "ConfigeekClient.getConfigStoreApi: result", configStoreApiResult);
                        return [2 /*return*/, configStoreApiResult];
                    case 2:
                        e_2 = _a.sent();
                        (0, utils_1.warn)(this.config.apiKey, "ConfigeekClient.getConfigStoreApi: caught error", e_2);
